...
class LeerlingController  
{
   ...
   private function klassenAction()
    {
       $gebruiker = $this->model->getGebruiker();
       $this->view->set("gebruiker",$gebruiker);
    ...
    private function bekijkklasAction()
    {
       $gebruiker = $this->model->getGebruiker();
       $this->view->set("gebruiker",$gebruiker);
       $klassen = $this->model->getKlassen2();
       $this->view->set('klassen', $klassen);
       $contacten = $this->model->getContacten2();
        $this->view->set('contacten', $contacten);
    }
    
    private function bekijkklas1Action()
    {
       $gebruiker = $this->model->getGebruiker();
       $this->view->set("gebruiker",$gebruiker);
       $klassen = $this->model->getKlassen2();
       $this->view->set('klassen', $klassen);
       $contacten = $this->model->getContacten1();
        $this->view->set('contacten', $contacten);
    }
