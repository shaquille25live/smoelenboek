<?php
namespace nl\yc\ict\ao\telefoonlijst\models;

use nl\yc\ict\ao\telefoonlijst\utils\Foto as FOTO;
   ...
   public function uitloggen()
   {
    ...
    public function getAfdelingen() 
    {
     ...
     public function addboek()
     {
        ...
        $sql = "INSERT IGNORE INTO `boeken`(`titel`,`omschrijving`) VALUES (:titel,:omschrijving)";
        $stmnt = $this->db->prepare($sql);
    ...
    public function getBoeken()
    {
       ...
       $stmnt = $this->db->prepare($sql);
       $stmnt->execute();
       $boeken = $stmnt->fetchAll(\PDO::FETCH_CLASS,__NAMESPACE__.'\db\boeken');    
       return $boeken;
    }
